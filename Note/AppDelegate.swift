...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func createContainer(competion: @escaping (NSPersistentContainer) -> ()) {
        ...
        container.loadPersistentStores { (_, error) in
            ...
            DispatchQueue.main.async { competion(container) }
        }
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        createContainer { container in
            ...
            let vc = nc.topViewController as? NotesTableViewController{
                //print(vc)
                vc.backgroudContext = container.newBackgroundContext()
            }
        }
